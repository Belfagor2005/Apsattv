...
wget --no-check-certificate --no-cache --no-dns-cache 'https://github.com/Belfagor2005/Apsattv/archive/refs/heads/main.tar.gz'
tar -xzf main.tar.gz
...
echo ""
echo "#########################################################"
echo "#           Apsattv Live INSTALLED SUCCESSFULLY         #"
